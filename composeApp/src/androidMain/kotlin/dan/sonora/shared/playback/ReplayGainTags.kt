...
object ReplayGainTags {
	...
	private const val KEY_ALBUM_GAIN = "sonora.rg.albumGain"
	private const val KEY_ALBUM_PEAK = "sonora.rg.albumPeak"
	private const val KEY_TRACK_GAIN = "sonora.rg.trackGain"
	private const val KEY_TRACK_PEAK = "sonora.rg.trackPeak"
	private const val KEY_BASE_GAIN = "sonora.rg.baseGain"
	private const val KEY_FALLBACK_GAIN = "sonora.rg.fallbackGain"
	...
	fun read(mediaItem: MediaItem?): DomainReplayGain? {
		...
		if (!extras.keySet().any { it.startsWith("sonora.rg.") }) return null
