...
import paige.navic.shared.playback.ExoPlayerFactory
import paige.navic.shared.playback.EqualizerSettingsProvider
import paige.navic.shared.playback.NavicAudioRenderersFactory
import paige.navic.shared.playback.PlaybackEngine
 ...
 * `Player` ([paige.navic.shared.playback.CrossfadePlayer]). Notifications, Android Auto,
...
class PlaybackService : MediaSessionService(), KoinComponent {
	...
	private fun createPlayerFactory(): ExoPlayerFactory {
		...
		// AudioProcessor chain. Keep it disabled while Navic installs its real-time DSP sink.
		...
		return ExoPlayerFactory {
			...
			ExoPlayer.Builder(this, NavicAudioRenderersFactory(this, equalizerSettingsProvider))
