...
private fun LocalMusicPage(
	...
	OnboardingMessagePage(
		title = "Local Music",
		body = "Navic+ can play music stored on this device, even when you are offline.",
			...
			scope.launch {
				when (permissionManager.requestLocalMusicPermission()) {
					...
					PermissionRequestResult.PermanentlyDenied -> {
						status = "Navic+ needs access to your music library to play songs stored on your device. You can allow access now or later from Settings."
					}
				}
			}
		},
