...
import paige.navic.ui.screens.settings.SettingsAdvancedEqualizerScreen
...
import paige.navic.ui.screens.stats.AdvancedStatisticsScreen
	...
	SharedTransitionLayout {
		CompositionLocalProvider(
			...
			NavicTheme {
				...
				// Automatic update checks and prompts are intentionally disabled for Navic+.
				// Reintroduce this only with a Navic+-owned update provider and user-facing flow.
			}
		}
	}
}
...
private fun entryProvider(
	...
	return androidx.navigation3.runtime.entryProvider {
		...
		entry<Screen.Insights>(metadata = navtabMetadata) { key ->
			paige.navic.ui.screens.stats.InsightsScreen(key.nested)
		}
