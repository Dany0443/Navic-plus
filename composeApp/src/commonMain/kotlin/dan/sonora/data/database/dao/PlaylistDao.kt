...
import dan.sonora.data.database.relations.PlaylistWithSongs
...
LIMIT 1
""")
	fun getPlaylistByIdFlow(playlistId: String): Flow<PlaylistWithSongs?>
	...
	/**
	 * Playlist tracks are valid library tracks even when the server does not expose them through
	 * an album-detail response (for example, tracks without album metadata).
	 */
