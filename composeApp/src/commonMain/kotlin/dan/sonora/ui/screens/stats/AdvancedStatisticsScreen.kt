...
import dan.sonora.ui.screens.stats.components.AdvancedStatisticsSectionCard
import dan.sonora.ui.screens.stats.viewmodels.AdvancedStatisticsUiState
	...
	Scaffold(
		...
		LazyColumn(
			...
			when (val currentState = state) {
				AdvancedStatisticsUiState.NoProvider -> item {
					Text("Connect a service in Settings › Insights to see your statistics.")
				}
